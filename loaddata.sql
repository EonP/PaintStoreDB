...
INSERT INTO PRODUCT (p_id, p_name, unit_price, description, discount_pourcentage, m_id) VALUES
    ...
    (108, 'Painters Tape', 4.99, 'Masking tape for clean edges and lines', 10, 6),
...
INSERT INTO HAS_IN_STOCK (p_id, s_id, quantity) VALUES
    -- Store 1
    (1, 1, 100), (2, 1, 150), (4, 1, 300), (5, 1, 50), (6, 1, 130),
    ...
    -- Store 3
    (1, 3, 95), (2, 3, 145), (4, 3, 250), (5, 3, 55), (6, 3, 120),
    ...
    -- Store 5
    (1, 5, 105), (2, 5, 135), (4, 5, 285), (5, 5, 70), (6, 5, 140),
    ...
    -- Store 8
    (1, 8, 98), (2, 8, 142), (4, 8, 260), (5, 8, 60), (6, 8, 155),
